...
import com.yuta.yutaold.ui.adapters.layoutmanagers.SpanningLinearLayoutManager;
import com.yuta.yutaold.ui.dialogs.CustomDialog;
import com.yuta.yutaold.ui.dialogs.project.ProjectDialog;
import com.yuta.app.utils.ImageUtils;
...
import static com.yuta.app.utils.UserUtils.getPath;
...
public class ProjectsAdapter extends BaseAdapter<ProjectDto, BaseAdapter.ViewHolder<ProjectDto>> {
    ...
    public class ProjectViewHolder extends ViewHolder<ProjectDto> {
        ...
        private void setupProjectFields(ProjectDto project) {
            ImageUtils.loadImageToImageViewWithoutCaching(photo, project.getPhoto());
